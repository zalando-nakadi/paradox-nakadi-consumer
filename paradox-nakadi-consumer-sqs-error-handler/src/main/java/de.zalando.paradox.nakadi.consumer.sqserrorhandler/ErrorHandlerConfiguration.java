...
public class ErrorHandlerConfiguration {
    ...
    @Bean
    public SQSErrorHandler sqsErrorHandler(final SQSConfiguration sqsConfiguration, final AmazonSQS amazonSQS,
            final ObjectMapper objectMapper) {
        return new SQSErrorHandler(sqsConfiguration, amazonSQS, objectMapper);
    }

    @Bean
    public SQSQueueHelper sqsQueueHelper(final SQSConfiguration sqsConfiguration, final AmazonSQS amazonSQS) {
        return new SQSQueueHelper(sqsConfiguration, amazonSQS);
    }
}
